...
import uk.ac.sheffield.dcs.smdStudio.framework.diagram.EllipticalNode;
...
public class CircularFinalStateNode extends EllipticalNode {
	...
	public CircularFinalStateNode() {
		setBounds(new Rectangle2D.Double(0, 0, DEFAULT_DIAMETER + 2
				* DEFAULT_GAP, DEFAULT_DIAMETER + 2 * DEFAULT_GAP));
	}
