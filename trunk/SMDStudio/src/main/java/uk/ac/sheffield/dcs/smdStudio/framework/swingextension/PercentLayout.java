...
/**
 * CLASS TAKEN FROM L2FPROD. Now included in Swinglabs API!!! (under the Apache License, Version 2.0)
 * 
 * PercentLayout. <BR>
    ...
    public void setConstraint(Component component, Object constraints)
    {
        ...
        else if (constraints instanceof String)
        {
            ...
            if (s.endsWith("%"))
            {
                ...
                if (value > 1 || value < 0) throw new IllegalArgumentException("percent value must be >= 0 and <= 100");
