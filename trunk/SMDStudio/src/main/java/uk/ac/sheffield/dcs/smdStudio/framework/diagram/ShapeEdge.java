...
/**
 * A class that assumes that an edge can yield its shape and then takes
 * advantage of the fact that containment testing can be done by stroking the
 * shape with a fat stroke. NOTE: Ideally, you should be able to draw the same
 * shape that is used for containment testing. However, in JDK 1.4,
