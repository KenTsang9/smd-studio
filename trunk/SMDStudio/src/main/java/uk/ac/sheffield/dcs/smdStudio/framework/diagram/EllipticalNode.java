...
public abstract class EllipticalNode extends RectangularNode {
	 ...
	 * 
	 * @see
	 * uk.ac.sheffield.dcs.smdStudio.framework.Node#getConnectionPoint(com.horstmann.
	 * violet.framework.Direction)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uk.ac.sheffield.dcs.smdStudio.framework.AbstractNode#getShape()
	 */
	public Shape getShape() {
		return new Ellipse2D.Double(getBounds().getX(), getBounds().getY(),
