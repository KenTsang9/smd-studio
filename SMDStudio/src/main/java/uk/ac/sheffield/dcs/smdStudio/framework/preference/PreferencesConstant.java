...
package uk.ac.sheffield.dcs.smdStudio.framework.preference;
...
public class PreferencesConstant
{
    ...
    /**
     * Constant just used as file separator for OPENED_FILES_ON_WORKSPACE
     */
    public static final PreferencesConstant OPENED_FILES_SEPARATOR = new PreferencesConstant("\n");
