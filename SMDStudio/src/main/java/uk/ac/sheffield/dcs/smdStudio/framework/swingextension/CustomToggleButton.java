...
/**
 * This class as the same behavoiuyr of an toggle button but its state (selected
 * or not) directly acts on it graphical rendering.
 * 
...
public class CustomToggleButton extends JPanel {
	 ...
	 */
	public CustomToggleButton(String text, Icon icon, Color selectedColor,
			Color selectedBorderColor, Color unselectedColor) {
		this.iconLabel.setIcon(icon);
		this.textLabel.setText(text);
		this.textLabel.setFont(ThemeManager.getInstance().getTheme()
				.getTOGGLEBUTTON_FONT());
		...
		setUI(new CustomToggleButtonUI(selectedColor, selectedBorderColor,
				unselectedColor));
		this.textLabel.setPreferredSize(new Dimension(MAX_TEXT_WIDTH,
	...
	public void setPreferredSize(Dimension p) {
		...
		this.textLabel.setPreferredSize(new Dimension((int) p.getWidth(),
				(int) getBounds().getHeight()));
	}
	...
	private void setDefaultPreferredSize() {
		setPreferredSize(new Dimension(MAX_TEXT_WIDTH, (int) getPreferredSize()
				.getHeight()));
	}
