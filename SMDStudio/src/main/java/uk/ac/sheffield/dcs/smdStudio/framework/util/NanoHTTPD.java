...
public class NanoHTTPD
{
    ...
    private String encodeUri(String uri)
    {
        ...
        while (st.hasMoreTokens())
        {
            ...
            {
                // Deprecated Java 1.1 compliant code -> newUri += URLEncoder.encode( tok );
    ...
    public Response serveFile(String uri, Properties header, File homeDir, boolean allowDirectoryListing)
    {
        ...
        if (!homeDir.isDirectory()) return new Response(HTTP_INTERNALERROR, MIME_PLAINTEXT,
        ...
        if (uri.startsWith("..") || uri.endsWith("..") || uri.indexOf("../") >= 0) return new Response(HTTP_FORBIDDEN,
                MIME_PLAINTEXT, "FORBIDDEN: Won't serve ../ for security reasons.");
        ...
        if (f.isDirectory())
        {
            ...
            else if (allowDirectoryListing)
            {
                ...
                if (uri.length() > 1)
                {
                    ...
                    if (slash >= 0 && slash < u.length()) msg += "<b><a href=\"" + uri.substring(0, slash + 1)
                            + "\">..</a></b><br/>";
                }
    ...
    static
    {
        StringTokenizer st = new StringTokenizer("htm        text/html " + "html       text/html " + "txt        text/plain "
                ...
                + "png        image/png " + "mp3        audio/mpeg " + "m3u        audio/mpeg-url " + "pdf        application/pdf "
