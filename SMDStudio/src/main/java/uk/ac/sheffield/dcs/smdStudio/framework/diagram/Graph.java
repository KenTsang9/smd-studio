...
public interface Graph
{
     ...
     */
    public abstract void attachChildNode(int index, Node parentNode, Node childNode);
     ...
     * @param childNode the child node to add
     */
    public abstract void detachChildNode(int index, Node parentNode, Node childNode);
     ...
     */
    public abstract void removeNodesAndEdges(Collection<? extends Node> nodesToRemove, Collection<? extends Edge> edgesToRemove);
     ...
     */
    public abstract void connect(Edge e, Node aStart, Point2D sPoint, Node anEnd, Point2D ePoint);
    ...
    public abstract void fireEdgeAdded(Edge e, Point2D startPoint, Point2D endPoint);
