...
public interface Node extends Serializable, Cloneable
{
     ...
     */
    boolean checkAddEdge(Edge e, Point2D p1, Point2D p2);
     ...
     */
    boolean checkAddNode(Node n, Point2D p);
     ...
     */
    boolean checkPasteChildren(Collection<Node> children);
     ...
     */
    void layout(Graphics2D g2, Grid grid);
